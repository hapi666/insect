...
func (*RangeReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_d954120a2319ff8f, []int{2}
}

func (m *RangeReply) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_RangeReply.Unmarshal(m, b)
}
func (m *RangeReply) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_RangeReply.Marshal(b, m, deterministic)
}
func (m *RangeReply) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RangeReply.Merge(m, src)
}
func (m *RangeReply) XXX_Size() int {
	return xxx_messageInfo_RangeReply.Size(m)
}
func (m *RangeReply) XXX_DiscardUnknown() {
	xxx_messageInfo_RangeReply.DiscardUnknown(m)
}

var xxx_messageInfo_RangeReply proto.InternalMessageInfo

func (m *RangeReply) GetUrls() []string {
	if m != nil {
		return m.Urls
	}
	return nil
...
func init() {
	proto.RegisterType((*PushQueueRequest)(nil), "model.PushQueueRequest")
	proto.RegisterType((*PopQueueReply)(nil), "model.PopQueueReply")
	proto.RegisterType((*RangeReply)(nil), "model.RangeReply")
	proto.RegisterType((*SisMemberRequest)(nil), "model.SisMemberRequest")
	proto.RegisterType((*SisMemberReply)(nil), "model.SisMemberReply")
	proto.RegisterType((*SadDRequest)(nil), "model.SadDRequest")
}

func init() { proto.RegisterFile("model.proto", fileDescriptor_d954120a2319ff8f) }

var fileDescriptor_d954120a2319ff8f = []byte{
	// 312 bytes of a gzipped FileDescriptorProto
	,
}
...
type DBServiceClient interface {
	...
	RangeQueue(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*RangeReply, error)
...
func (c *dBServiceClient) PushQueue(ctx context.Context, in *PushQueueRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/model.DBService/PushQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) PopQueue(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*PopQueueReply, error) {
	...
	err := c.cc.Invoke(ctx, "/model.DBService/PopQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) RangeQueue(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*RangeReply, error) {
	out := new(RangeReply)
	err := c.cc.Invoke(ctx, "/model.DBService/RangeQueue", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) SisMember(ctx context.Context, in *SisMemberRequest, opts ...grpc.CallOption) (*SisMemberReply, error) {
	...
	err := c.cc.Invoke(ctx, "/model.DBService/SisMember", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *dBServiceClient) SadD(ctx context.Context, in *SadDRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/model.DBService/SadD", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DBServiceServer interface {
	...
	RangeQueue(context.Context, *empty.Empty) (*RangeReply, error)
...
func (*UnimplementedDBServiceServer) RangeQueue(ctx context.Context, req *empty.Empty) (*RangeReply, error) {
...
func _DBService_PushQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.DBService/PushQueue",
	}
...
func _DBService_PopQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.DBService/PopQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_RangeQueue_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.DBService/RangeQueue",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_SisMember_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.DBService/SisMember",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _DBService_SadD_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/model.DBService/SadD",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
